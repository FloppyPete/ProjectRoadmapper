...
**Success criteria:**
- [ ] Session template includes YAML frontmatter with all required fields
- [ ] New sessions auto-populate metadata from project context
- [ ] AI assistant instructions updated to read and use metadata
- [ ] Documentation updated with metadata usage examples
