...
**Next task:** Add reasoning marker definitions and documentation

**Implementation:**
1. Add reasoning marker definitions to session template
2. Update AI assistant instructions in PROJECT_ROADMAP.md
